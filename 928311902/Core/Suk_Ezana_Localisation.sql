...
--------------------------------------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------------------------------------
		("LOC_LEADER_SUK_EZANA_NAME",  																						"en_US",
		"Ezana"																),
--------------------------------------------------------------------------------------------------------------------------
-- ULA
--------------------------------------------------------------------------------------------------------------------------
		("LOC_TRAIT_LEADER_SUK_AKSUMITE_COINAGE_NAME",  																				"en_US",
		"Aksumite Coinage"															),
		("LOC_TRAIT_LEADER_SUK_AKSUMITE_COINAGE_DESCRIPTION",  																		"en_US",
...
-- Agenda
--------------------------------------------------------------------------------------------------------------------------
		("LOC_AGENDA_SUK_EZANAS_STONE_NAME",  																								"en_US",
		"Ezana’s Stone"														),
		("LOC_AGENDA_SUK_EZANAS_STONE_DESCRIPTION",  																						"en_US",
		...
		("LOC_DIPLO_KUDO_LEADER_SUK_EZANA_REASON_ANY",  																					"en_US",
		"(You have a strong economy and a strong military.)"															),
		("LOC_DIPLO_MODIFIER_SUK_EZANAS_STONE_KUDOS",  																					"en_US",
		"Ezana is pleased you have a strong economy and a strong military"															),

		("LOC_DIPLO_WARNING_LEADER_SUK_EZANA_REASON_ANY",  																				"en_US",
		"(You have a strong economy but a weak military.)"															),
		("LOC_DIPLO_MODIFIER_SUK_EZANAS_STONE_WARNING",  																					"en_US",
		"Ezana is disappointed you have a strong economy but a weak military"															),
--------------------------------------------------------------------------------------------------------------------------
-- UI
--------------------------------------------------------------------------------------------------------------------------
		("LOC_IMPROVEMENT_SUK_STELE_NAME",  																								"en_US",
		"Hawelti"														),
		("LOC_IMPROVEMENT_SUK_STELE_DESCRIPTION",  																						"en_US",
		...
		("LOC_PEDIA_IMPROVEMENTS_PAGE_IMPROVEMENT_SUK_STELE_CHAPTER_HISTORY_PARA_1",  																						"en_US",
...
-- Diplo
--------------------------------------------------------------------------------------------------------------------------
		("LOC_LOADING_INFO_LEADER_SUK_EZANA",  																		"en_US",
		...
		("LOC_DIPLO_REJECT_DECLARE_FRIEND_FROM_AI_LEADER_SUK_EZANA_ANY",                                      "en_US",
		"A shame."),
		("LOC_DIPLO_ACCEPT_DECLARE_FRIEND_FROM_AI_LEADER_SUK_EZANA_ANY",                                      "en_US",
		"Wonderful."),
		("LOC_DIPLO_DECLARE_FRIEND_FROM_AI_LEADER_SUK_EZANA_ANY",                                     "en_US",
		"Let us be tied by more than bonds of commerce! Join me in friendship!"),
		("LOC_DIPLO_REJECT_DECLARE_FRIEND_FROM_HUMAN_LEADER_SUK_EZANA_ANY",                                     "en_US",
		"This does not seem to be to be in Aksum's best interest. I decline."),
		("LOC_DIPLO_ACCEPT_DECLARE_FRIEND_FROM_HUMAN_LEADER_SUK_EZANA_ANY",                                     "en_US",
		"We are pleased to accept your offer of friendship."),
		("LOC_DIPLO_DECLARE_WAR_FROM_AI_LEADER_SUK_EZANA_ANY",                                      "en_US",
		"God will protect Aksum! Your doom is the inevtable outcome!"),
		("LOC_DIPLO_DECLARE_WAR_FROM_HUMAN_LEADER_SUK_EZANA_ANY",                                     "en_US",
		"I do this for Aksum. And with God on our side we cannot fail!"),
		("LOC_DIPLO_DEFEAT_FROM_HUMAN_LEADER_SUK_EZANA_ANY",                                      "en_US",
		"So rarely have I seen this side of war."),
		("LOC_DIPLO_DEFEAT_FROM_AI_LEADER_SUK_EZANA_ANY",                                     "en_US",
		"So rarely have I seen this side of war."),
		("LOC_DIPLO_DELEGATION_FROM_AI_LEADER_SUK_EZANA_ANY",                                     "en_US",
		"I've sent a delegation with a gift of injera and berbere. Will you accept?"),
		("LOC_DIPLO_REJECT_DELEGATION_FROM_HUMAN_LEADER_SUK_EZANA_ANY",                                     "en_US",
		"We decline"),
		("LOC_DIPLO_ACCEPT_DELEGATION_FROM_HUMAN_LEADER_SUK_EZANA_ANY",                                     "en_US",
		"Your envoy and gifts are appreciated. I might send a caravan later to trade for more."),
		("LOC_DIPLO_DENOUNCE_FROM_AI_LEADER_SUK_EZANA_ANY",                                     "en_US",
		"You are a disgrace. I will tell the world, they will know who you truly are. (Denounces You)."),
		("LOC_DIPLO_DENOUNCE_FROM_HUMAN_LEADER_SUK_EZANA_ANY",                                      "en_US",
		"Lies and slander! You will pay dearly for this."),
		("LOC_DIPLO_FIRST_MEET_LEADER_SUK_EZANA_ANY",                                     "en_US",
		...
		("LOC_DIPLO_FIRST_MEET_VISIT_RECIPIENT_LEADER_SUK_EZANA_ANY",                                     "en_US",
		"We have a city nearby, an excellent place to send your traders, I might add."),
		("LOC_DIPLO_FIRST_MEET_NEAR_INITIATOR_POSITIVE_LEADER_SUK_EZANA_ANY",                                     "en_US",
		"I gladly accept."),
		("LOC_DIPLO_FIRST_MEET_NO_MANS_INFO_EXCHANGE_LEADER_SUK_EZANA_ANY",                                     "en_US",
		"Axum is of course, a rich and wonderful city. Tell me more of your capital."),
		("LOC_DIPLO_GREETING_LEADER_SUK_EZANA_ANY",                                     "en_US",
		"Welcome."),
		("LOC_DIPLO_WARNING_EXIT_LEADER_SUK_EZANA_ANY",                                     "en_US",
		"Your coffers are full, but your borders are undefended. Do you want to be plundered?"),
		("LOC_DIPLO_KUDO_EXIT_LEADER_SUK_EZANA_ANY",                                      "en_US",
		"A strong and wealthy nation makes for an excellent trading partner."),
		("LOC_DIPLO_MAKE_ALLIANCE_FROM_AI_LEADER_SUK_EZANA_ANY",                                      "en_US",
		"Would you like to form an alliance?"),
		("LOC_DIPLO_REJECT_MAKE_DEAL_FROM_AI_LEADER_SUK_EZANA_ANY",                                     "en_US",
		"{LOC_DIPLO_REJECT_DECLARE_FRIEND_FROM_AI_LEADER_SUK_EZANA_ANY}"),
		("LOC_DIPLO_ACCEPT_MAKE_DEAL_FROM_AI_LEADER_SUK_EZANA_ANY",                                     "en_US",
		"{LOC_DIPLO_ACCEPT_DECLARE_FRIEND_FROM_AI_LEADER_SUK_EZANA_ANY}"),
		("LOC_DIPLO_MAKE_PEACE_AI_ACCEPT_DEAL_LEADER_SUK_EZANA_ANY",                                      "en_US",
		"Good, this war has gone on for too long."),
		("LOC_DIPLO_MAKE_PEACE_AI_REFUSE_DEAL_LEADER_SUK_EZANA_ANY",                                      "en_US",
		"No. I cannot accept."),
		("LOC_DIPLO_MAKE_PEACE_FROM_AI_LEADER_SUK_EZANA_ANY",                                     "en_US",
		"Let us come to peace."),
		("LOC_DIPLO_ACCEPT_OPEN_BORDERS_FROM_HUMAN_LEADER_SUK_EZANA_ANY",                                     "en_US",
		"Very well, I hereby grant you permission to pass through my lands."),
		("LOC_DIPLO_REJECT_OPEN_BORDERS_FROM_HUMAN_LEADER_SUK_EZANA_ANY",                                     "en_US",
		"We are not interested at this time."),
		("LOC_DIPLO_OPEN_BORDERS_FROM_AI_LEADER_SUK_EZANA_ANY",                                     "en_US",
		"I humbly request permission to march through your borders. We will keep the peace."),
		("LOC_DIPLO_WARNING_TOO_MANY_TROOPS_NEAR_ME_LEADER_SUK_EZANA_ANY",                                      "en_US",
		"Do not show your blade unless you mean to strike. Move your soldiers from our lands."),
--------------------------------------------------------------------------------------------------------------------------
-- Quote and Pedia
--------------------------------------------------------------------------------------------------------------------------
		("LOC_PEDIA_LEADERS_PAGE_SUK_EZANA_QUOTE",  																		"en_US",
		"When spiders unite, they can tie up a lion."  															),
		
		("LOC_PEDIA_LEADERS_PAGE_SUK_EZANA_TITLE",														"en_US",
		"Ezana"),
		("LOC_PEDIA_LEADERS_PAGE_SUK_EZANA_SUBTITLE",													"en_US",
		"King of Aksum, Himyar, Raydan, Kush, Saba, Salhin, Tsarad, of the Ethiopians and the Beja"),
		("LOC_PEDIA_LEADERS_PAGE_LEADER_SUK_EZANA_CHAPTER_CAPSULE_BODY",							"en_US",
		...
		("LOC_PEDIA_LEADERS_PAGE_LEADER_SUK_EZANA_CHAPTER_DETAILED_BODY",							"en_US",
		...
		("LOC_PEDIA_LEADERS_PAGE_LEADER_SUK_EZANA_CHAPTER_HISTORY_PARA_1",						"en_US",
		...
		("LOC_PEDIA_LEADERS_PAGE_LEADER_SUK_EZANA_CHAPTER_HISTORY_PARA_2",		"en_US",
		...
		("LOC_PEDIA_LEADERS_PAGE_LEADER_SUK_EZANA_CHAPTER_HISTORY_PARA_3",		"en_US",
		...
		("LOC_PEDIA_LEADERS_PAGE_LEADER_SUK_EZANA_CHAPTER_HISTORY_PARA_4",		"en_US",
		...
		("LOC_PEDIA_LEADERS_PAGE_LEADER_SUK_EZANA_CHAPTER_HISTORY_PARA_5",		"en_US",
