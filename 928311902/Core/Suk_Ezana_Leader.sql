...
VALUES	('AGENDA_SUK_EZANAS_STONE_KUDOS',			'InitialValue',					8),
		...
		('AGENDA_SUK_EZANAS_STONE_KUDOS',			'SimpleModifierDescription',	'LOC_DIPLO_MODIFIER_SUK_EZANAS_STONE_KUDOS'),
...
--==========================================================================================================================
-- Mod Support
-- Ethiopia will have handled this.
--==========================================================================================================================
-- Leader_Titles 
------------------------------------------------------------	
INSERT INTO Leader_Titles
			(LeaderType, 			GovernmentType,	PolicyType,	LeaderTitle)	
SELECT		'LEADER_SUK_EZANA',		GovernmentType,	PolicyType,	LeaderTitle
FROM Leader_Titles WHERE LeaderType = 'LEADER_SUK_ZARAYAQOB';
--==========================================================================================================================
-- CivilizationLeaders
--==========================================================================================================================
