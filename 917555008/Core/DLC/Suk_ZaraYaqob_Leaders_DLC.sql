...
VALUES	('LEADER_SUK_ZARAYAQOB_DLC',		'LEADER_SUK_ZARAYAQOB_NEUTRAL',		'LEADER_DEFAULT_BACKGROUND',	0);
--==========================================================================================================================
-- LEADERS
--==========================================================================================================================
-- Types
...
INSERT INTO Types
		(Type,								Kind)
VALUES	('LEADER_SUK_ZARAYAQOB_DLC',		'KIND_LEADER');
-------------------------------------
-- Leaders
-------------------------------------
INSERT INTO Leaders
		(LeaderType,						Name,												InheritFrom,		SceneLayers)
VALUES	('LEADER_SUK_ZARAYAQOB_DLC',		'LOC_LEADER_SUK_ZARAYAQOB_DLC_NAME',				'LEADER_DEFAULT',	4);
-------------------------------------
-- LeaderQuotes
-------------------------------------
INSERT INTO LeaderQuotes
		(LeaderType,						Quote)
VALUES	('LEADER_SUK_ZARAYAQOB_DLC',		'LOC_PEDIA_LEADERS_PAGE_SUK_ZARAYAQOB_DLC_QUOTE');
-------------------------------------
-- LeaderTraits
-------------------------------------
INSERT INTO LeaderTraits
		(LeaderType,						TraitType)
VALUES	('LEADER_SUK_ZARAYAQOB_DLC',		'TRAIT_LEADER_SUK_DEBRE_MITMAQ');
-- -------------------------------------
-- -- FavoredReligions
-- -------------------------------------
INSERT OR REPLACE INTO FavoredReligions
		(LeaderType,						ReligionType)
VALUES	('LEADER_SUK_ZARAYAQOB_DLC',		'RELIGION_ORTHODOXY');

UPDATE FavoredReligions
SET ReligionType = 'RELIGION_C1_ORIENTAL'
WHERE LeaderType = 'LEADER_SUK_ZARAYAQOB_DLC'
...
VALUES	('LEADER_SUK_ZARAYAQOB_DLC',		'AGENDA_SUK_BOOK_OF_LIGHT');
-------------------------------------
-- Agendas
-------------------------------------
INSERT INTO Agendas
...
VALUES  ('LEADER_SUK_ZARAYAQOB_DLC',	'CIVILIZATION_ETHIOPIA',		'LOC_CITY_NAME_DEBRE_BERHAN');
--==========================================================================================================================
--==========================================================================================================================