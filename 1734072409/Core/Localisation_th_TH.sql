...
--------------------------------------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------------------------------------
		("LOC_LEADER_SUK_NARAI_NAME",  																						"th_TH",
		"สมเด็จพระนารายณ์"																),
--------------------------------------------------------------------------------------------------------------------------
-- ULA
--------------------------------------------------------------------------------------------------------------------------
		("LOC_TRAIT_LEADER_SUK_SIAMOISES_NAME",  																				"th_TH",
		"คณะราชทูตสยาม"															),
		("LOC_TRAIT_LEADER_SUK_SIAMOISES_DESCRIPTION",  																		"th_TH",
		"แต้มพันธมิตรจะเติบโตเร็วขึ้นอีก 0.25 ต่อรอบ. พันธมิตรของคุณมอบ +15 [ICON_Gold] ทอง, +3 [ICON_Culture] วัฒนธรรม และ +2 [ICON_FAVOR] การสนับสนุนทางการทูต ให้กับอารยธรรมทั้งสองฝ่าย. เขตตลาดน้ำและสิ่งปลูกสร้างภายในเขตจะมอบ +1 [ICON_Science] วิทยาศาตร์ ให้กับทุก [ICON_TradeRoute] เส้นทางการค้า ระหว่างประเทศที่เริ่มต้นในเมืองนั้น."),
--------------------------------------------------------------------------------------------------------------------------
-- Agenda
--------------------------------------------------------------------------------------------------------------------------
		("LOC_AGENDA_SUK_PHRAKHLANG_NAME",  																								"th_TH",
		"กรมพระคลัง"														),
		("LOC_AGENDA_SUK_PHRAKHLANG_DESCRIPTION",  																						"th_TH",
		"ชอบอารยธรรมที่มี [ICON_FAVOR] การสนับสนุนทางการทูตสูงและเป็นพันธมิตร.[NEWLINE]ไม่ชอบอารยธรรมที่มีพันธมิตรหลายพันธมิตร แต่ไม่ได้เป็นพันธมิตรกับสยาม"															),

		("LOC_DIPLO_KUDO_LEADER_SUK_NARAI_REASON_ANY",  																					"th_TH",
		"(You are an ally with high Diplomatic Favor.)"															),
		("LOC_DIPLO_MODIFIER_SUK_PHRAKHLANG_ALLIED",  																					"th_TH",
		"Narai is pleased to have such a diplomatic ally"															),

		("LOC_DIPLO_WARNING_LEADER_SUK_NARAI_REASON_ANY",  																				"th_TH",
		"(You have many allies, but aren't allied with him.)"															),
		("LOC_DIPLO_MODIFIER_SUK_PHRAKHLANG_NOT_ALLIED",  																					"th_TH",
		"Narai is slighted he is not one of your many allies"															),
--------------------------------------------------------------------------------------------------------------------------
-- Loading Screen
--------------------------------------------------------------------------------------------------------------------------
		("LOC_LOADING_INFO_LEADER_SUK_NARAI",  																		"th_TH",
...
-- First Meet
-------------------------------------
		("LOC_DIPLO_FIRST_MEET_LEADER_SUK_NARAI_ANY",	"th_TH",
		...
		("LOC_DIPLO_FIRST_MEET_VISIT_RECIPIENT_LEADER_SUK_NARAI_ANY",	"th_TH",
		...
		("LOC_DIPLO_FIRST_MEET_NEAR_INITIATOR_POSITIVE_LEADER_SUK_NARAI_ANY",	"th_TH",
		"Your generosity speaks well of you. Thank you."),
		("LOC_DIPLO_FIRST_MEET_NO_MANS_INFO_EXCHANGE_LEADER_SUK_NARAI_ANY",	"th_TH",
		"If we are to trade with one another we must know the location of one another’s capitals. Agreed?"),
-------------------------------------
-- Agenda Diplo
-------------------------------------
		("LOC_DIPLO_KUDO_EXIT_LEADER_SUK_NARAI_ANY",	"th_TH",
		...
		("LOC_DIPLO_WARNING_EXIT_LEADER_SUK_NARAI_ANY",	"th_TH",
...
-------------------------------------
	-- Human Declares War
		("LOC_DIPLO_DECLARE_WAR_FROM_HUMAN_LEADER_SUK_NARAI_ANY",	"th_TH",
	...
	-- AI Declares War
		("LOC_DIPLO_DECLARE_WAR_FROM_AI_LEADER_SUK_NARAI_ANY",	"th_TH",
...
-------------------------------------
		...
		("LOC_DIPLO_ACCEPT_MAKE_ALLIANCE_FROM_AI_LEADER_SUK_NARAI_ANY",	"th_TH",
		...
		("LOC_DIPLO_RENEW_ALLIANCE_FROM_AI_LEADER_SUK_NARAI_ANY",	"th_TH",
...
--------------------------------------------------------------------------------------------------------------------------
		...
		("LOC_PEDIA_LEADERS_PAGE_SUK_NARAI_TITLE",														"th_TH",
		"Narai"),
		("LOC_PEDIA_LEADERS_PAGE_SUK_NARAI_SUBTITLE",													"th_TH",
		"Somdet Phra Narai Maharat"),
		("LOC_PEDIA_LEADERS_PAGE_LEADER_SUK_NARAI_CHAPTER_CAPSULE_BODY",							"th_TH",
		...
		("LOC_PEDIA_LEADERS_PAGE_LEADER_SUK_NARAI_CHAPTER_DETAILED_BODY",							"th_TH",
		...
		("LOC_PEDIA_LEADERS_PAGE_LEADER_SUK_NARAI_CHAPTER_HISTORY_PARA_1",						"th_TH",
		...
		("LOC_PEDIA_LEADERS_PAGE_LEADER_SUK_NARAI_CHAPTER_HISTORY_PARA_2",		"th_TH",
		...
		("LOC_PEDIA_LEADERS_PAGE_LEADER_SUK_NARAI_CHAPTER_HISTORY_PARA_3",		"th_TH",
		...
		("LOC_PEDIA_LEADERS_PAGE_LEADER_SUK_NARAI_CHAPTER_HISTORY_PARA_4",		"th_TH",
		...
		("LOC_PEDIA_LEADERS_PAGE_LEADER_SUK_NARAI_CHAPTER_HISTORY_PARA_5",		"th_TH",
		...
		("LOC_PEDIA_LEADERS_PAGE_LEADER_SUK_NARAI_CHAPTER_HISTORY_PARA_6",		"th_TH",
		...
		("LOC_PEDIA_LEADERS_PAGE_LEADER_SUK_NARAI_CHAPTER_HISTORY_PARA_7",		"th_TH",
		...
		("LOC_PEDIA_LEADERS_PAGE_LEADER_SUK_NARAI_CHAPTER_HISTORY_PARA_8",		"th_TH",
		...
		("LOC_PEDIA_LEADERS_PAGE_LEADER_SUK_NARAI_CHAPTER_HISTORY_PARA_9",		"th_TH",
		...
		("LOC_PEDIA_LEADERS_PAGE_LEADER_SUK_NARAI_CHAPTER_HISTORY_PARA_10",		"th_TH",
		...
		("LOC_PEDIA_LEADERS_PAGE_LEADER_SUK_NARAI_CHAPTER_HISTORY_PARA_11",		"th_TH",
