...
VALUES	('LEADER_ALEXANDER', 'Unique', 'COLOR_STANDARD_WHITE_MD2', 'COLOR_SC_BRIGHT_YELLOW', 'COLOR_SC_DARK_GREECE_BLUE', 'COLOR_STANDARD_YELLOW_LT', 'COLOR_STANDARD_ORANGE_DK', 'COLOR_STANDARD_YELLOW_MD', 'COLOR_SC_DARK_CYAN', 'COLOR_SC_LIGHT_CYAN'),
		('LEADER_AMANITORE', 'Unique', 'COLOR_SC_TAN', 'COLOR_SC_MEDIUM_BROWN', 'COLOR_SC_COCOA', 'COLOR_SC_LIGHTEST_BROWN', 'COLOR_STANDARD_YELLOW_LT', 'COLOR_SC_PERSIMMON', 'COLOR_SC_MEDIUM_PURPLE', 'COLOR_SC_LIGHTEST_BROWN'),
		...
		('LEADER_CHANDRAGUPTA', 'Unique', 'COLOR_STANDARD_AQUA_LT', 'COLOR_STANDARD_PURPLE_DK', 'COLOR_SC_DARK_TEAL', 'COLOR_STANDARD_GREEN_LT', 'COLOR_SC_MEDIUM_PURPLE', 'COLOR_SC_MEDIUM_TEAL', 'COLOR_SC_DARK_DRAB', 'COLOR_STANDARD_MAGENTA_LT'),
		...
		('LEADER_DIDO', 'Unique', 'COLOR_STANDARD_MAGENTA_DK', 'COLOR_SC_LIGHT_WISTERIA', 'COLOR_SC_DARK_WISTERIA', 'COLOR_SC_LIGHT_GREY', 'COLOR_SC_DARK_PURPLE', 'COLOR_SC_LIGHT_WISTERIA', 'COLOR_SC_LIGHT_GREY', 'COLOR_STANDARD_PURPLE_MD'),
		...
		('LEADER_GENGHIS_KHAN', 'Unique', 'COLOR_SC_BRICK', 'COLOR_SC_PERSIMMON', 'COLOR_STANDARD_ORANGE_MD', 'COLOR_STANDARD_RED_DK', 'COLOR_SC_TAN', 'COLOR_STANDARD_RED_DK', 'COLOR_SC_DARK_CRANBERRY', 'COLOR_STANDARD_ORANGE_MD'),
		('LEADER_GILGAMESH', 'Unique', 'COLOR_STANDARD_BLUE_DK', 'COLOR_STANDARD_ORANGE_LT', 'COLOR_STANDARD_AQUA_DK', 'COLOR_STANDARD_AQUA_LT', 'COLOR_SC_LIGHT_PASTEL_YELLOW', 'COLOR_STANDARD_BLUE_DK', 'COLOR_STANDARD_ORANGE_LT', 'COLOR_STANDARD_BLUE_DK'),
		('LEADER_GITARJA', 'Unique', 'COLOR_SC_CRANBERRY', 'COLOR_STANDARD_AQUA_LT', 'COLOR_SC_LIGHT_TEAL', 'COLOR_SC_DARK_RED_VIOLET', 'COLOR_STANDARD_PURPLE_LT', 'COLOR_STANDARD_RED_DK', 'COLOR_STANDARD_AQUA_LT', 'COLOR_SC_CRANBERRY'),
		...
		('LEADER_HOJO', 'Unique', 'COLOR_STANDARD_WHITE_LT', 'COLOR_STANDARD_RED_DK', 'COLOR_SC_TRUE_BLUE', 'COLOR_STANDARD_WHITE_LT', 'COLOR_STANDARD_RED_DK', 'COLOR_STANDARD_YELLOW_MD', 'COLOR_SC_WISTERIA', 'COLOR_STANDARD_BLUE_DK'),
		...
		('LEADER_PACHACUTI', 'Unique', 'COLOR_SC_PERSIMMON', 'COLOR_STANDARD_YELLOW_MD', 'COLOR_SC_DARK_PERSIMMON', 'COLOR_SC_LIGHT_PASTEL_GREEN', 'COLOR_SC_DARK_GREEN', 'COLOR_SC_PERSIMMON', 'COLOR_STANDARD_PURPLE_MD', 'COLOR_STANDARD_WHITE_LT'),
		...
		('LEADER_PETER_GREAT', 'Unique', 'COLOR_STANDARD_YELLOW_MD', 'COLOR_STANDARD_WHITE_DK', 'COLOR_STANDARD_WHITE_LT', 'COLOR_STANDARD_BLUE_MD', 'COLOR_SC_DARK_DRAB', 'COLOR_STANDARD_YELLOW_LT', 'COLOR_SC_LIGHTEST_TRUE_BLUE', 'COLOR_STANDARD_WHITE_LT'),
		...
		('LEADER_POUNDMAKER', 'Unique', 'COLOR_SC_LIGHTEST_BROWN', 'COLOR_STANDARD_ORANGE_DK', 'COLOR_STANDARD_BLUE_DK', 'COLOR_STANDARD_GREEN_MD', 'COLOR_SC_LIGHT_BROWN', 'COLOR_STANDARD_AQUA_LT', 'COLOR_SC_LIGHT_PASTEL_GREEN', 'COLOR_SC_DARK_GREEN'),
		...
		('LEADER_SALADIN', 'Unique', 'COLOR_STANDARD_YELLOW_MD', 'COLOR_STANDARD_GREEN_DK', 'COLOR_SC_DARK_PASTEL_GREEN', 'COLOR_STANDARD_WHITE_LT', 'COLOR_SC_MEDIUM_GREY', 'COLOR_STANDARD_YELLOW_LT', 'COLOR_STANDARD_GREEN_DK', 'COLOR_SC_LIGHT_PASTEL_YELLOW'),
		...
		('LEADER_TAMAR', 'Unique', 'COLOR_STANDARD_WHITE_LT', 'COLOR_STANDARD_ORANGE_MD', 'COLOR_STANDARD_WHITE_MD2', 'COLOR_STANDARD_RED_MD', 'COLOR_SC_GREECE_BLUE', 'COLOR_STANDARD_YELLOW_MD', 'COLOR_SC_DARK_CYAN', 'COLOR_STANDARD_YELLOW_LT'),
		...
		('LEADER_SIMON_BOLIVAR', 'Unique', 'COLOR_STANDARD_BLUE_DK', 'COLOR_SC_BRIGHT_YELLOW', 'COLOR_SC_BRIGHT_YELLOW', 'COLOR_STANDARD_BLUE_DK', 'COLOR_SC_CYAN', 'COLOR_SC_BRIGHT_YELLOW', 'COLOR_STANDARD_RED_MD', 'COLOR_SC_LIGHT_CYAN'),
		...
		('LEADER_MENELIK', 'Unique', 'COLOR_SC_GREECE_BLUE', 'COLOR_SC_BRIGHT_YELLOW', 'COLOR_SC_DARK_PASTEL_GREEN', 'COLOR_SC_BRIGHT_YELLOW', 'COLOR_SC_DARK_GREEN', 'COLOR_SC_LIGHT_CRANBERRY', 'COLOR_SC_CYAN', 'COLOR_SC_BRIGHT_YELLOW'),
		('LEADER_CATHERINE_DE_MEDICI_ALT', 'Unique', 'COLOR_STANDARD_WHITE_LT', 'COLOR_STANDARD_YELLOW_DK', 'COLOR_STANDARD_BLUE_MD', 'COLOR_SC_BRIGHT_YELLOW', 'COLOR_SC_LIGHT_TRUE_BLUE', 'COLOR_STANDARD_WHITE_LT', 'COLOR_SC_GREECE_BLUE', 'COLOR_SC_BRIGHT_YELLOW'),
		('LEADER_T_ROOSEVELT_ROUGHRIDER', 'Unique', 'COLOR_STANDARD_BLUE_DK', 'COLOR_SC_LIGHT_GREY', 'COLOR_SC_LIGHT_TRUE_BLUE', 'COLOR_STANDARD_WHITE_LT', 'COLOR_SC_DARK_CYAN', 'COLOR_SC_LIGHT_GREY', 'COLOR_STANDARD_WHITE_MD2', 'COLOR_STANDARD_BLUE_DK');
...
'LEADER_VICTORIA', 'LEADER_WILHELMINA', 'LEADER_SIMON_BOLIVAR', 'LEADER_LADY_SIX_SKY', 'LEADER_MENELIK', 'LEADER_T_ROOSEVELT_ROUGHRIDER', 'LEADER_CATHERINE_DE_MEDICI_ALT');
