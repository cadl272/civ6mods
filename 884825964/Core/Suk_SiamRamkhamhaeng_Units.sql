...
SELECT 		'UNIT_SUK_SIAM_CHANGSUEK',				'LOC_UNIT_SUK_SIAM_CHANGSUEK_NAME',				'LOC_UNIT_SUK_SIAM_CHANGSUEK_DESCRIPTION',	'TRAIT_CIVILIZATION_UNIT_SUK_SIAM_CHANGSUEK',	Combat + 5,	BaseMoves - 1,	Cost + 20,	AdvisorType, BaseSightRange, ZoneOfControl, Domain, FormationClass, PurchaseYield, PromotionClass, Maintenance, MandatoryObsoleteTech, PrereqTech
