...
--------------------------------------------------------------------
		...
		("LOC_TRAIT_CIVILIZATION_SUK_SAGAS_OF_THE_ICELANDERS_DESCRIPTION_XP2",  
		"Historic Moments also provide [ICON_GreatWriter] Great Writer Points. Campuses, Theater Squares, and Commercial Hubs gain a Major adjacency bonus from Natural Wonders. Volcanoes, Volcanic Soil, and Geothermal Fissures provide +2 Appeal to adjacent tiles."),											 
...
-- Named Places
--------------------------------------------------------------------
		("LOC_NAMED_RIVER_THJORSA_NAME",				"Þjórsá"),
		("LOC_NAMED_RIVER_HVITA_NAME",					"Hvítá"),
		("LOC_NAMED_RIVER_FNJOSKA_NAME",				"Fnjóská"),
		("LOC_NAMED_RIVER_KUTHAFLJOT_NAME",				"Kúðafljót"),
		("LOC_NAMED_RIVER_SKJALFANDAFLJOT_NAME",		"Skjálfandafljót"),
		("LOC_NAMED_RIVER_JOKULSA_A_FJOLLUM_NAME",		"Jökulsá á Fjöllum"),
		("LOC_NAMED_RIVER_JOKULSA_A_DAL_NAME",			"Jökulsá á Dal"),
		("LOC_NAMED_MOUNTAIN_ESJAN_NAME",				"Esjan"),
		("LOC_NAMED_MOUNTAIN_HOFSJOKULL_NAME",			"Hofsjökull"),
		("LOC_NAMED_MOUNTAIN_VATNAJOKULL_NAME",			"Vatnajökull"),
		("LOC_NAMED_MOUNTAIN_LANGJOKULL_NAME",			"Langjökull"),
		("LOC_NAMED_MOUNTAIN_MYRDALSJOKULL_NAME",		"Mýrdalsjökull"),
		("LOC_NAMED_MOUNTAIN_LANDMANNALAUGAR_NAME",		"Landmannalaugar Mountains"),
		("LOC_NAMED_VOLCANO_HEKLA_NAME",				"Hekla Volcano"),
		("LOC_NAMED_VOLCANO_BARTHARBUNGA_NAME",			"Bárðarbunga"),
		("LOC_NAMED_VOLCANO_KATLA_NAME",				"Katla Volcano"),
		("LOC_NAMED_VOLCANO_KRAFLA_CALDERA_NAME",		"Krafla Caldera"),
		("LOC_NAMED_VOLCANO_ASKJA_CALDERA_NAME",		"Askja Caldera"),
		("LOC_NAMED_VOLCANO_ELDFELL_NAME",				"Eldfell Volcano"),
		("LOC_NAMED_VOLCANO_THRIHNJUKAGIGUR_NAME",		"Þríhnjúkagígur"),
		("LOC_NAMED_LAKE_THINGVALLAVATN_NAME",			"Þingvallavatn"),
		("LOC_NAMED_LAKE_MYVATN_NAME",					"Mývatn"),
		("LOC_NAMED_LAKE_KERITH_NAME",					"Kerið"),
		("LOC_NAMED_LAKE_OSKJUVATN_NAME",				"Öskjuvatn"),
		("LOC_NAMED_LAKE_JOKULSARLON_NAME",				"Jökulsárlón"),
		("LOC_NAMED_LAKE_LAGARFLJOT_NAME",				"Lagarfljót"),
		("LOC_NAMED_LAKE_HVITARVATN_NAME",				"Hvítárvatn"),
		("LOC_NAMED_SEA_BAKKAFLOI_NAME",				"Bakkaflói"),
		("LOC_NAMED_SEA_FAXAFLOI_NAME",					"Faxaflói"),
		("LOC_NAMED_SEA_GRUNNAVIK_NAME",				"Grunnavík"),
		("LOC_NAMED_SEA_HERADSFLOI_NAME",				"Héradsflói"),
		("LOC_NAMED_SEA_HUNAFLOI_NAME",					"Húnaflói"),
		("LOC_NAMED_SEA_THISTILFJORTHUR_NAME",			"Þistilfjörður"),
		("LOC_NAMED_SEA_BREITHAFJORTHUR_NAME",			"Breiðafjörður"),
		("LOC_NAMED_SEA_ISAFJARTHARDJUP_NAME",			"Ísafjarðardjúp"),
		("LOC_NAMED_SEA_SKAGAFJORTHUR_NAME",			"Skagafjörður"),
		("LOC_NAMED_SEA_EYJAFJORTHUR_NAME",				"Eyjafjörður"),
--------------------------------------------------------------------
-- Info
--------------------------------------------------------------------
...
--========================================================================================================================
		...
		"Icelandic unique civilian unit. The Lawspeaker provides +4 Loyalty per turn when garrisoned in a City Center, or gives +50% adjacency bonuses when garrisoned in a District. Lawspeakers can only be trained in your [ICON_Capital] Capital."),
...
--========================================================================================================================
		...
		"A district unique to Iceland for city growth. Replaces the Aqueduct district.[NEWLINE][NEWLINE]Instead of the Aqueduct's usual restrictions and bonuses, Torfbæir provide +3 [ICON_Housing] Housing, +1 [ICON_Food] Food and +1 [ICON_Production] Production. This bonus increases to +4 [ICON_Housing], +2 [ICON_Food] and +2 [ICON_Production] when built on tiles with Charming Appeal, or to +5 [ICON_Housing], +3 [ICON_Food] and +3 [ICON_Production] when built on tiles with Breathtaking Appeal. Does not provide an adjacency bonus to Industrial Zones.[NEWLINE][NEWLINE]If built adjacent to a Geothermal Fissure +1 [ICON_Amenities] Amenity. Prevents [ICON_Food] Food loss during Drought. Torfbæir cannot be built on Desert tiles."),
...
--------------------------------------------------------------------
		...
		"Settlers and Recon units receive +1 [ICON_Movement] Movement, doubled during a [ICON_GLORY_DARK_AGE] Dark Age. Units escorting a Settler inherit their [ICON_Movement] Movement speed. Cities on tiles with Breathtaking appeal, or within 2 tiles of a Natural Wonder receive +2 [ICON_Amenities] Amenities, +4 Loyalty."),
--------------------------------------------------------------------
-- Agenda
--------------------------------------------------------------------
