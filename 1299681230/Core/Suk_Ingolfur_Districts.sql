...
INSERT INTO Districts
			(DistrictType,						Name,										Description,								Cost,		TraitType,										PrereqTech,		Appeal,	Housing,	Aqueduct,		CaptureRemovesDistrict,		PlunderType,		PlunderAmount,		AdvisorType,		CostProgressionModel,		CostProgressionParam1,		RequiresPlacement,		RequiresPopulation,		NoAdjacentCity,		InternalOnly,		ZOC,		CaptureRemovesBuildings,		CaptureRemovesCityDefenses,		MilitaryDomain,		TravelTime,		CityStrengthModifier)
SELECT		'DISTRICT_SUK_TORFBAEIR',			'LOC_DISTRICT_SUK_TORFBAEIR_NAME',			'LOC_DISTRICT_SUK_TORFBAEIR_DESCRIPTION',	Cost,		'TRAIT_CIVILIZATION_DISTRICT_SUK_TORFBAEIR',	PrereqTech,		1,		3,			0,				1,							PlunderType,		PlunderAmount,		AdvisorType,		CostProgressionModel,		CostProgressionParam1,		RequiresPlacement,		RequiresPopulation,		NoAdjacentCity,		InternalOnly,		ZOC,		CaptureRemovesBuildings,		CaptureRemovesCityDefenses,		MilitaryDomain,		TravelTime,		CityStrengthModifier
